...
/**
 *
 * VideoQuizService - Test Class
 *
 * This class provides a basic testing framework for the microservice VideoQuizService. It was
 * generated by the CAE (Community Application Framework).
 *
 */
public class VideoQuizTest {
  ...
  public void testGetQuiz() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/getQuiz/{id}", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testGetQuiz': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
